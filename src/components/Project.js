      ...
      <div className="row justify-content-start mt-4 text-white p-4">
        <div className="col-md-4 col-sm-12 mb-4">
          <div className="project-card">
            ...
            <img src="/images/pj_1.png" alt="휴일도안심" className="project-img" />
        ...
        <div className="col-md-4 col-sm-12 mb-4">
          <div className="project-card">
            ...
            <img src="/images/pj_2.png" alt="포켓몬덱스" className="project-img" />
        ...
        <div className="col-md-4 col-sm-12 mb-4">
          <div className="project-card">
            ...
            <img src="/images/pj_3.png" alt="Portfolio" className="project-img" />
        ...
        <div className="col-md-4 col-sm-12 mb-4">
          <div className="project-card">
            ...
            <img src="/images/pj_4.png" alt="메인 기획" className="project-img" />
        ...
        <div className="col-md-4 col-sm-12 mb-4">
          <div className="project-card">
            ...
            <img src="/images/pj_5.png" alt="xxx 페이지" className="project-img" />
        ...
        <div className="col-md-4 col-sm-12 mb-4">
          <div className="project-card">
            ...
            <img src="/images/pj_1.png" alt="아트국" className="project-img" />
            <p>아트쿡 페이지 퍼블리싱 작업</p>
            <p>
              <strong>기술 스택:</strong> HTML, CSS, JavaScript
            </p>
